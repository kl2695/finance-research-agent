...
How to correctly apply financial analysis — the right procedure for each type of problem.
This complements financial_concepts.py (formulas) with methodology (correct analytical process).
